...
from train_pumpkin import load_model, load_tomogram
...
def get_args():
    ...
    parser.add_argument("--size", default=16, type=int, metavar=metavar, help="Size of subtomograms (either 16 or 32) in each dimension (Default: 16)", dest="subtomogram_size")
    parser.add_argument("--radius", default=7, type=int, metavar=metavar, help="Radius of a particle (in voxel) in tomograms (Default: 7)", dest="particle_radius")
    parser.add_argument("--pick", default=1000, type=int, metavar=metavar, help="Number of particles to pick from a tomogram (Default: 1000)", dest="num_pick_particles")
...
if __name__ == "__main__":
    ...
    tomogram = load_tomogram(tomogram_path=f"{args.tomograms_path}/{args.tomogram_name}.mrc")
